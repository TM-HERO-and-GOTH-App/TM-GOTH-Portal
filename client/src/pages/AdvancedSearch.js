            ...
            <>
              ...
              <div className="row">
                <form name="form" onSubmit={advancedSearch} onReset={reset}>
                  ...
                  <div className="col-sm-2 advance-search-select-input">
                    <select className="form-control chosen-select" name="keyCaseTypeID" value={caseType} onChange={(e) => setCaseType(e.target.value)} data-placeholder="Case Type..." style={{ backgroundColor: "#FAFAFA" }}>
                  ...
                  <div className="col-sm-2 advance-search-select-input">
                    <select className="form-control chosen-select" name="keyHeroGroup" value={heroGroupType} onChange={(e) => setHeroGroupType(e.currentTarget.value)} data-placeholder="HERO Group..." style={{ backgroundColor: "#FAFAFA" }}>
                  ...
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyFullname" placeholder="HERO Name" value={fullNameInput} onChange={(e) => setFullNameInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyEmail" placeholder="Email" value={emailInput} onChange={(e) => setEmailInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyNricNum" placeholder="NRIC Number" value={nricInput} onChange={(e) => setNRICInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="ikeyCaseNum" placeholder="Case ID" value={caseNumberInput} onChange={(e) => setCaseNumberInput(e.target.value)} />
                  </div>

                  <div className="space-20" />

                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyVipName" placeholder="VIP Name" value={vipNameInput} onChange={(e) => setVIPNameInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyCustomerName" placeholder="Customer Name" value={customerNameInput} onChange={(e) => customerNameInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keySrNum" placeholder="SR Number" value={srNumberInput} onChange={(e) => setSRNumberInput(e.target.value)} />
                  </div>
                  <div className="col-sm-2 advance-search-select-input">
                    <input className="form-control" type="text" name="keyTtNum" placeholder="TT Number" value={ttNumberInput} onChange={(e) => setTTNumberInput(e.target.value)} />
                  </div>
