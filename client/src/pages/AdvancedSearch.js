                        ...
                        <form name="form" onSubmit={advancedSearch} onReset={reset}>
                            ...
                            <div className="col-sm-2 advance-search-select-input">
                                <input className="form-control" type="text" name="keyCustomerName"
                                       ...
                                       onChange={(e) => customerNameInput(e.target.value)}/>
                            </div>
                            <div className="col-sm-2 advance-search-select-input">
                                                    ...
                                                    return (data.response === 'FAILED') ?
                                                        <TableRow>
                                                            <TableCell colSpan={11}>
                                                                <span
                                                                    style={{color: 'red'}}>Search result is empty</span>
                                                            </TableCell>
                                                        </TableRow>
                                                        :
                                                        <TableRow key={index}>
