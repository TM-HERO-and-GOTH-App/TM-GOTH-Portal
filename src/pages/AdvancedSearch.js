											...
											<TableBody className="table-body">
												{
													(searchResult === [] || searchResult === undefined || searchResult.length === 0) ?
															<TableRow><TableCell style={{fontSize: '1.2rem'}} colSpan={14}><span
																	style={{color: 'red'}}>Search result is empty</span></TableCell></TableRow>
															:
															searchResult.map((data, index) => {
																...
																return <TableRow key={index} lassName="table-row">
																	...
																	<TableCell style={{fontSize: '1.2rem'}}>{data.CASE_TYPE}</TableCell>
																	<TableCell style={{fontSize: '1.2rem'}}>
																		<div align="center">
																			{data.VIP ? <span
																	...
																	<TableCell style={{fontSize: '1.2rem'}} align='center'>{data.ELIGIBILITY}</TableCell>
																	<TableCell style={{fontSize: '1.2rem'}}>{data.PRODUCT_NAME}</TableCell>
																	...
																	<TableCell style={{fontSize: '1.2rem'}}>{data.AREA_LOCATION}</TableCell>
																	<TableCell style={{fontSize: '1.2rem'}}>
																		<div align="center">
