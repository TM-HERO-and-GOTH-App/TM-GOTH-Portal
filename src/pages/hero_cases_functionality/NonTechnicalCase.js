...
function NonTechnicalCase() {
    ...
    const createTT = () => {
        CreateCaseService.createNovaTT(customerProfileFromNova.CustInfo[0].CustomerRowID[0], customerProfileFromNova.BillInfo[0].BillingAccountNo[0], customerProfileFromNova.BillInfo[0].BillingAccountRowID[0],
            null, productSelect,
            '800', //temp value to be change
            null, userData.fullName, customerProfileFromNova.ServiceInfo[0].ServiceRowID[0],
            null, 'Open', null, customerProfileFromNova.CustInfo[0].PrimaryContactRowID[0], customerProfileFromNova.CustInfo[0].PrimaryContactRowID[0],
            ...
            <form onSubmit={createNonTechnicalCase}>
                <div className="hb-input-group w-100" id="searchbar">
                    ...
                    <div className="hb-input-group-append" onClick={checkNetwork}
                         style={{display: `${searchBarType === "service" ? "" : "none"}`}}>
                        <button className="btn btn-secondary" type="button"><LocationSearchingIcon fontSize="large"/>
                        </button>
                    </div>
