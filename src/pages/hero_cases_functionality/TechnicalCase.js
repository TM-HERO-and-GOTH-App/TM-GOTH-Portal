...
function TechnicalCase() {
  ...
  const checkNetwork = () => {
    NextService.checkNetworkOutage("HERO-20220425-0001", searchBarInput).then(
      (res, err) => {
  ...
  const getCustomerProfile = (e) => {
    e.preventDefault();
    CreateCaseService.getCustomerProfileFromNova(
      searchBarInput,
      customerICInput
    ).then((res) => {
      // console.log(res.data);
      setCustomerNameInput(
        res.data.STTRetrieveServiceAcctResponse.Response[0].CustInfo[0]
          .AccountName
      );
      setCustomerMobileNumberInput(
        res.data.STTRetrieveServiceAcctResponse.Response[0].CustInfo[0].MobileNo
      );
      setLocation(
        lovData
          .filter(
            (data) =>
              ...
              res.data.STTRetrieveServiceAcctResponse.Response[0].ServiceInfo[0]
                .ServiceAddress[0].State
          )
          .map((data) => data.L_ID)
      );
    });
  ...
  const createCTT = (serviceID, symptomCode, mobileNumber) => {
    CreateCaseService.autoCreateCTT(serviceID, symptomCode, mobileNumber).then(
      (err, res) => {
      ...
      <Modal open={openModal} onClose={() => setOpenModal(false)}>
        <Box sx={modalStyle}>
          ...
          <ul style={{fontSize: '1.5em'}}>
            <li>NTT ID</li>
            <li>ETTR</li>
            <li>Fault Category</li>
            <li>Service Impact</li>
          </ul>
		  <button className="btn btn-primary" style={{marginLeft: '23vw'}} onClick={() => setOpenModal(false)}>Ok</button>
        </Box>
      </Modal>
      <div className="hb-container">
        ...
        <form onSubmit={createTechnicalCase}>
          <div className="hb-input-group w-100" id="searchbar">
            ...
            <div
              className="hb-input-group-append"
              style={{
                display: `${searchBarType === "service" ? "" : "none"}`,
              }}
            >
              <button
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="customerName">
              Customer Name*
            </label>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="customerNumber">
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="loggerNumber">
              Logger Mobile Number*
            </label>
            <div className="hb-input-box">
              <input
                type="tel"
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="type">
              Type*
            </label>
            <div className="hb-input-box" id="type" name="assurance">
              <select
                ...
                disabled
              >
                <option key={28} value={28} disabled>
                  Assurance
                </option>
              </select>
            </div>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="area">
              Area*
            </label>
            <div className="hb-input-box">
              <select
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="subarea">
              Sub-Area*
            </label>
            <div className="hb-input-box">
              <select
              ...
              >
                ...
                {lovData
                  .filter((data) => data.L_GROUP === "SUB-AREA")
                  .map((data, key) => (
                    <option key={data.L_ID} value={data.L_ID}>
                      {data.L_NAME}
                    </option>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="product">
              Product*
            </label>
            <div className="hb-input-box">
              <select
              ...
              >
                ...
                {lovData
                  .filter((data) => data.L_GROUP === "PRODUCT")
                  .map((data, key) => (
                    <option key={data.L_ID} value={data.L_ID}>
                      {data.L_NAME}
                    </option>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="symptom">
              Symptom*
            </label>
            <div className="hb-input-box">
              <select
              ...
              >
                ...
                {searchBarInput.endsWith("@streamyx") === true
                  ? lovData
                      .filter(
                        (data) =>
                          data.L_GROUP === "SYMPTOM" && data.L_ID === 658
                      )
                      .map((data, key) => (
                        <option key={data.L_ID} value={data.L_ID}>
                          {data.L_NAME}
                  ...
                  : lovData
                      .filter((data) => data.L_GROUP === "SYMPTOM")
                      .map((data, key) => (
                        <option key={data.L_ID} value={data.L_ID}>
                          {data.L_NAME}
                        </option>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="location">
              Location*
            </label>
            <div className="hb-input-box">
              <select
              ...
              >
                ...
                {lovData
                  .filter((data) => data.L_GROUP === "STATE")
                  .map((data, key) => (
                    <option key={data.L_ID} value={data.L_ID}>
                      {data.L_NAME}
                    </option>
          ...
          <div className="hb-input-group">
            <label className="hb-detail" htmlFor="description">
              Description*
            </label>
            <div className="hb-input-box">
              <textarea
