				...
				<div className="hb-container">
					...
					<form onSubmit={createTechnicalCase}>
						...
						<div className="hb-input-group">
							<label className="hb-detail" htmlFor="customerName">Customer Name<span
						...
						<div className="hb-input-group">
							<label className="hb-detail" htmlFor="customerNumber">Customer Mobile Number<span
									style={{color: 'red'}}>*</span></label>
							<div className="hb-input-box">
								<input
										type="tel"
						...
						<div className="hb-input-group">
							<label className="hb-detail" htmlFor="loggerNumber">Logger Mobile Number<span
									style={{color: 'red'}}>*</span></label>
							<div className="hb-input-box">
								<input
										type="tel"
