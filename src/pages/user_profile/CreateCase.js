...
function CreateCase() {
	...
	const createICPSR = () => {
		CreateCaseService.createICPSR(
				customerProfileFromNova.CustInfo[0].CustomerRowID[0], 'New', 'New',
				userData.fullName, areaType, subAreaSelect, moment.now().toString(),
				null, null, null,
				...
				caseDescriptionInput, null, null, productType,
				customerProfileFromNova.ServiceInfo[0].ServiceRowID[0], null, null
		).then(res => {
						...
						<>
							<form name="form" onSubmit={createCase} onReset={resetForm}>
								...
								<div align="right" className='row-cols-auto'>
									<input className="input-medium" style={{height: '100%', padding: '4px 8px 4px 8px', margin: '1vh 0'}}
									       type='text'
