...
class Createcase extends React.Component {
  ...
  createCase(e) {
    e.preventDefault();
    CreateCaseService.createCase(this.state.token, this.state.customerName, this.state.ic, this.state.mobileNumber, this.state.caseDescription, this.state.stateType, this.state.sourceType, this.state.subSourceType, this.state.caseType)
      .then(res => {
        console.log(res);
