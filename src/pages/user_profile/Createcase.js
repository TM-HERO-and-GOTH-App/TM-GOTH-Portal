                          ...
                          <input className="input-sm" style={{width: '100%'}} type="text" name="mobileNum"
                                 ...
                                 onChange={(e) => setMobileNumberInput(e.target.value)}/>
                                        ...
                                        <div className="profile-info-row">
                                            ...
                                            <div className="profile-info-value">
                                                <select className='chosen-select form-control' name='symptomID'
                            ...
                            lovData.filter(filter => filter.lovGroup === 'AREA').map((data, key) => {
                              return <option key={key} value={data.lovID}>{data.lovName}</option>
                                        ...
                                        <div className="profile-info-row">
                                            ...
                                            <div className="profile-info-value">
                                                <select className='chosen-select form-control' name='areaID'
                                                        value={areaType} onChange={(e) => setAreaType(e.target.value)}>
                                        ...
                                        <div className="profile-info-row">
                                            ...
                                            <div className="profile-info-value">
                                                <select className='chosen-select form-control' name='subAreaID'
                                                        value={areaType} onChange={(e) => setAreaType(e.target.value)}>
                                        ...
                                        <div className="profile-info-row">
                                            ...
                                            <div className="profile-info-value">
                                                <select className='chosen-select form-control' name='productID'
                                                        value={productType}
