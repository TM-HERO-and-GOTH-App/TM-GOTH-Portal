                    ...
                    (<>
                                ...
                                <div className="profile-user-info profile-user-info-striped" style={{margin: 0}}>
                                    {
                                        caseData.ownerName ?
                                            ...
                                            <>
                                                <div className="profile-info-row">
                                                    <div className="profile-info-name" style={{width: '20%'}}>GROUP
                                                        POOL
                                                    </div>
                                                    <div className="profile-info-value">
                                                    <span className="editable" id="username">
                                                ...
                                                <div className="profile-info-row">
                                                    <div className="profile-info-name" style={{width: '20%'}}>CASE
                                                        OWNER
                                                    </div>
                                                    <div className="profile-info-value">
                                                        <span className="editable" id="username"><i
                                                            style={{color: 'red'}}>Un-Assigned</i></span>
                                                    </div>
                                                </div>
                                            </>
                                    }
                                    ...
                                    <div className="profile-info-row">
                                        ...
                                        <span className="editable" id="age">
                                            {caseData.areaLocation ? caseData.areaLocation :
                                    ...
                                    <div className="profile-info-row">
                                        ...
                                        <div className="profile-info-value">
                                            ...
                                            {caseData.longtitude ? caseData.latitude + ' / ' + caseData.longtitude :
                                                <i>Not provided</i>}
                                        </span>
                                        </div>
                                    </div>
                            ...
                            <div className="col-sm-6">
                                <div className="profile-user-info profile-user-info-striped" style={{margin: 0}}>
                                    ...
                                    <div className="profile-info-row">
                                        ...
                                        <div className="profile-info-value">
                                        <span className="editable" id="signup">
                                            {caseData.productName ? caseData.productName :
                                                <span style={{color: "gray"}}>n/a</span>}
                                        </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="profile-info-row">
                                        ...
                                        <div className="profile-info-value">
                                        <span className="editable" id="signup">
                                            {caseData.segmentName ? caseData.segmentName :
                                                <span style={{color: "gray"}}>n/a</span>}
                                        </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="profile-info-row">
                                        ...
                                        <div className="profile-info-value">
                                        <span className="editable" id="signup">
                                            {caseData.subSourceName ? caseData.subSourceName :
                                                <span style={{color: "gray"}}>n/a</span>}
                                        </span>
                                        </div>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                ...
                                {caseData.picture ? <img src={caseData.picture} alt='Case'/> :
                                    ...
                                    <div className="col-sm-12">
                                        <h4 className="header green">Geotag Map
                                            <div className="pull-right">
                                                <button className="btn btn-warning btn-xs" onclick="initMap(lat,lon);"
                                                        title="Reload Map">
